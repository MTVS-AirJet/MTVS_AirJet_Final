...
//클라이언트 단에서 Playerlist 업데이트 요청
void UK_GameInstance::SendPlayerListToClient_Implementation(AK_PlayerController* ClientController)
{
	//ClientController->ClientRPC_UpdatePlayerList(ConnectedPlayerNames);
}
